		...
		for align := range aligns.Achan {
			...
			if simplotOutImageFile != "none" {
				...
				colors := brewer.DivergingPalette{
					...
					// "Paired" palette from R color brewer
					Color: []color.Color{
						color.RGBA{R: 166, G: 206, B: 227, A: 255},
						color.RGBA{R: 31, G: 120, B: 180, A: 255},
						color.RGBA{R: 178, G: 223, B: 138, A: 255},
						color.RGBA{R: 51, G: 160, B: 44, A: 255},
						color.RGBA{R: 251, G: 154, B: 153, A: 255},
						color.RGBA{R: 227, G: 26, B: 28, A: 255},
						color.RGBA{R: 253, G: 191, B: 111, A: 255},
						color.RGBA{R: 255, G: 127, B: 0, A: 255},
						color.RGBA{R: 202, G: 178, B: 214, A: 255},
						color.RGBA{R: 106, G: 61, B: 154, A: 255},
						color.RGBA{R: 255, G: 255, B: 153, A: 255},
						color.RGBA{R: 177, G: 89, B: 40, A: 255},
